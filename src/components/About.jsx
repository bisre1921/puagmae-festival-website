...
const About = () => {
  ...
  return (
    <div className='relative py-16 md:py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white' id='about'>
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mt-10 md:mt-12'>
          <button 
            ...
            className='bg-goldenrod text-black px-8 py-3 rounded-lg text-base md:text-lg font-semibold shadow-lg hover:bg-yellow-600 hover:shadow-xl transition-all duration-300 transform hover:scale-105'
          >
        ...
        {isExpanded && (
          <div className='mt-10 md:mt-12'>
            <div className='bg-gray-800/50 backdrop-blur-sm p-6 md:p-8 rounded-xl border border-gray-700 max-w-4xl mx-auto'>
              <div className='space-y-6'>
                <p className='text-base md:text-lg leading-relaxed text-gray-200'>
